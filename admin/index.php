                                ...
                                <div class="card mini-stats">
                                    ...
                                    <div class="ml-3 mr-3">
                                        <div class="bg-white p-3 mini-stats-desc rounded">
                                            ...
                                            <h6 class="mt-0 mb-3">Instructors</h6>
...
?>
                            ...
                            <div class="col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="mt-0 header-title">Instructor News</h4>
                                        ...
                                        <form>
                                            <div class="row">
                                                <div class="col-8 rec-acti-input">
                                                    <input type="text" name="rec-input-text" class="form-control" placeholder="Add news for Instructors">
                                                </div>
                                                <div class="col-4 rec-acti-send">
                                                    <button class="btn-primary btn-block btn" type="button"><i class="mdi mdi-plus mr-1"></i>Add</button>
                                                </div>
