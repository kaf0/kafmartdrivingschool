...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Gertrude Seworh" name="author" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        ...
        <link rel="stylesheet" href="../instructor/fonts/material-design-iconic-font/css/material-design-iconic-font.css">
                    ...
                    <ul class="navbar-right d-flex list-inline float-right mb-0">
                        <li class="list-inline-item dropdown notification-list flags-dropdown d-none d-sm-inline-block">
                            ...
                            aria-haspopup="false" aria-expanded="false">
                                <img src="assets/images/flags/gh_flag.jpg" alt="" class="flag-img">
                                Ghana <i class="mdi mdi-chevron-down"></i>
                            </a>
                        </li>
                        ...
                        <li class="list-inline-item dropdown notification-list">
                            ...
                            aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="d-none d-md-inline-block ml-1">Gertrude Seworh<i class="mdi mdi-chevron-down"></i> </span>
                            </a>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="javascript:void(0);" class="waves-effect"><i class="ion-ribbon-a"></i><span> Instructors <span class="float-right menu-arrow"><i class="mdi mdi-chevron-right"></i></span> </span></a>
                                <ul class="submenu">
                                    <li><a href="instructors.php">Instructor List</a></li>
                                    <li><a href="instructor.php">Add New</a></li>
                                </ul>
                            </li>
                             ...
                             <li>
                                ...
                                <ul class="submenu">
                                    <li><a href="tickets.php">Ticket History</a></li>
                                </ul>
                            </li>
