                			...
                			<div class="row">
	                			...
	                			<a href="#" class="grid-item" style="background-image: url('assets/images/teacher-bg.jpg');">
	                				<div class="inner">
	                					...
	                					<span>Brong Ahafo</span>
	                				</div>
	                				
	                			</a>
                			</div>
                			<div class="row">
                				<a href="#" class="grid-item" style="background-image: url('assets/images/tour-guide-bg.jpg');">
	                				<div class="inner">
	                					<img src="assets/images/pz.png" alt="">
	                					<span>Volta</span>
	                				</div>
	                			</a>
	                			<a href="#" class="grid-item" style="background-image: url('assets/images/business-bg.jpg');">
	                				<div class="inner">
	                					<img src="assets/images/fr.png" alt="">
	                					<span>Northern Region</span>
	                				</div>
	                			</a>
	                			<a href="#" class="grid-item" style="background-image: url('assets/images/artist-bg.jpg');">
	                				<div class="inner">
	                					<img src="assets/images/gjk.png" alt="">
