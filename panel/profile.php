                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            ...
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item"><a href="#">Kafmart</a></li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" type="text" value="Gertrude Seworh" id="example-text-input">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Username</label>
                                            <div class="col-sm-4">
                                                <input class="form-control" type="text" value="kafmart" readonly id="example-text-input">
                                            </div>
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Email</label>
                                            <div class="col-sm-4">
                                                <input class="form-control" type="text" value="info@kafmart.com" id="example-text-input">
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-primary" role="alert">
                                               Welcome Back <strong>Gertrude Seworh</strong> Here is your account status.
                                        </div>
                                        <br><h4>Statistics</h4>
                                        <ul class="user-info">
