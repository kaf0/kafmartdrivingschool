                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive mt-4">
                                            ...
                                            <h4 class="mt-0 header-title">Allow Instructors To Create Users</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive mt-4">
                                            <div class="row">
                                                <div class="form-holder col-md-6">
                                                <input type="text" value="Kafmart Driving School" class="form-control">
                                            </div>
                                             <div class="form-holder col-md-6">
                                                <input type="text" value="support@kafmart.com" class="form-control">
                                            </div> 
                                            </div>
                                             <div class="row">
                                                <div class="form-holder col-md-6">
...
Kafmart Driving School"></textarea>
                                            </div>
                                            <div class="form-group mb-0">
                                                <div>
                                                    <button type="submit" class="btn btn-pink waves-effect waves-light">
