                                     ...
                                     <!-- Simple card -->
                                        <div id="page-1" class="row slide">
                                            ...
                                            <div id="1" class="card col-md-4 col-sm-12">
                                                ...
                                                <div class="card-body">
                                                    <h4 class="card-title font-20 mt-0"> Test 1</h4>
                                                    <p class="card-text">Questions from previous written exam tests.</p>
                                                   <button class="btn btn-primary btn-block waves-effect waves-light" onclick="window.location.href = 'test1/'">Take Test</button>
                                                </div>
                                            </div>
                                            <!-- Simple card -->
                                            <div id="2" class="card col-md-4 col-sm-12">
                                                <img class="card-img-top img-fluid" src="assets/images/auto.png" alt="Card image cap">
                                                <div class="card-body">
                                                    <h4 class="card-title font-20 mt-0">Test 2</h4>
                                                    <p class="card-text">Questions from previous written exam tests..</p>
                                                        <button class="btn btn-primary btn-block waves-effect waves-light"onclick="window.location.href = 'test1/'">Take Test</button>
                                                    </div>
                                            </div>
                                            ...
                                            <div id="2" class="card col-md-4 col-sm-12">
                                                <img class="card-img-top img-fluid" src="assets/images/auto.png" alt="Card image cap">
                                                <div class="card-body">
                                                    <h4 class="card-title font-20 mt-0">Test 3</h4>
                                                    <p class="card-text">Questions from previous written exam tests..</p>
                                                        <button class="btn btn-primary btn-block waves-effect waves-light"onclick="window.location.href = 'test1/'">Take Test</button>
                                                    </div>
                                            </div>
